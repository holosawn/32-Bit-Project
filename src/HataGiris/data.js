...
const secondButton = Veri2.data[0].defectButtonRecords.map((obj) => {
  const { boxColor, boxHeight, boxWidth, boxX, boxY, labelColor, labelText , picId , buttonId , lineX , lineY} =
    obj;

const List = Veri2.data[0].partDefects.map(obj => {
...
const firstButtons = Veri.data[0].defectButtonRecords.map((obj) => {
...
export {firstButtons,secondButton,Veri,Veri2}
